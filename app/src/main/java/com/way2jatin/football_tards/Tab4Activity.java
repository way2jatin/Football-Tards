...
public class Tab4Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.championstable);
        final WebView wv = (WebView) findViewById(R.id.webPage);
        wv.getSettings().setJavaScriptEnabled(true);
        wv.getSettings().setJavaScriptEnabled(true);
        wv.loadUrl("http://footballtards.com/champions-league-table");
        ...
        wv.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                final Toast showToastMessage = Toast.makeText(Tab4Activity.this, "Loading", Toast.LENGTH_SHORT);
